...
export default function Header({cart, removeFromCart, increaseQuantity, decreasedQuantity, clearCart, isEmpty, cartTotal} : HeaderProps ) {
                          ...
                          {cart.map(guitar => (
                            <tr key={guitar.id}>
                              ...
                              <td className="flex align-items-start gap-4">
                                <button type="button" className="btn btn-dark" onClick={() => decreasedQuantity(guitar.id)}>-</button>
                                  {guitar.quantity}
